...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__magic(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit__magic(void) { return NULL; }
#  else
     init_magic(void) { }
#  endif
#  endif
...
PyInit__magic(void)
{
  return _cffi_init("_magic", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_magic(void)
{
  _cffi_init("_magic", 0x2601, &_cffi_type_context);
}
#endif
